$(document).ready(function() {
    ...
    function cityWeather(cityName) {
        ...
        $.ajax({
           ...
           cardBody.append($('<h5 class="card-title">' + response.name + " (" + currentDate + ") " + "<img src='" + iconurl + "'>" + "</h5>"));
            
            
            cardBody.append($('<p class="card-text">' + "Temperature: " + farTemperature.toFixed(0)  + "</p>"));
            cardBody.append($('<p class="card-text">' + "Humidity: " + response.main.humidity + "</p>"));
            cardBody.append($('<p class="card-text">' + "Wind Speed: " + response.wind.speed + "</p>"));
